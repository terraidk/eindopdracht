...
<body>
    <div class="forms">
        ...
        <a href="manage_rents.php"
            style="position: fixed; bottom: 70px; right: 20px; padding: 10px 20px; background-color: rgb(140, 0, 140); color: #fff; border-radius: 5px; text-decoration: none; z-index: 9999;">Manage
            Rents</a>
